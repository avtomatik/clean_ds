...
# =============================================================================
# file_names = tuple(os.listdir(DIR))
# with ZipFile(Path(DIR).joinpath(ARCHIVE_NAME), 'w') as archive:
#     for file_name in file_names:
#         archive.write(Path(DIR).joinpath(file_name), compress_type=zipfile.ZIP_DEFLATED)
#         os.unlink(Path(DIR).joinpath(file_name))
# =============================================================================
...
# total.to_excel(Path(DIR).joinpath(FILE_NAME), index=False)
df = pd.read_excel(Path(DIR).joinpath(FILE_NAME))
plan_breakdown = {}
